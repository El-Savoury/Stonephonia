    ...
    public class TestScreen : GameScreen
    {
        ...
        public override void LoadAssets()
        {
            ...
            pusher = new Pusher(10, 50)
            {
                ...
                new Point(32, 32), new Point(0, 0), new Point(1, 1), 200, Color.White * 0.3f),
                mCollisionOffset = 0,
                mMaxSpeed = 4
            };
